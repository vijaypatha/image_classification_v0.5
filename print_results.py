    ...
    if (print_incorrect_dogs and 
        ...
        for key in results_dic:
            ...
            if results_dic[key][3] != results_dic[key][4]:
                print("Pet Label when classifier function misclassified ==> {:3}".format(results_dic[key][0]))
                print("Classifier Label when classifier function misclassified ==> {:3}".format(results_dic[key][1]))
